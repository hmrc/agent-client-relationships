...
class EmacConnectorSpec extends UnitSpec with OneServerPerSuite with WireMockSupport with GovernmentGatewayProxyStubs with DataStreamStub with MetricTestSupport {
