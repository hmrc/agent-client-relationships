...
import uk.gov.hmrc.agentclientrelationships.stubs.{AfiRelationshipStub, ClientDetailsStub, IfStub}
...
class StrideClientDetailsControllerIfISpec
    extends BaseControllerISpec
    with ClientDetailsStub
    with IfStub
    with AfiRelationshipStub {

  override def additionalConfig: Map[String, Any] = Map("hip.enabled" -> false, "hip.BusinessDetails.enabled" -> false)
